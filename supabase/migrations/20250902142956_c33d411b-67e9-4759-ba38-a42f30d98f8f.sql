-- Add TokenMigration smart contract to the database
INSERT INTO smart_contracts (
  ...
  '0x1234567890abcdef1234567890abcdef12345678', -- Placeholder address - admin can update
  ...
  true,
  (SELECT id FROM profiles WHERE email = 'johnny@elitweb3.com' LIMIT 1)
